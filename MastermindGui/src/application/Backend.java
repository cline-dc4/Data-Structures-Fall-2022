...
public interface Backend 
{
	...
	public static final char COLOR_PURPLE = 'p';
	...
	/**
	 * the getter for numberGuesses
	 * @return numberGuesses variable
	 */
	public int getNumberGuesses();

	/**
	 * the getter for hintHistoryArray
	 * @return hintHistoryArray 
	 */
	public int [][] getHintHistoryArray();

	/**
	 * A function that resets the MastermindBackend object
	 ...
	 * converted into the appropriate chars.(will just take first
	 * letter from the string and use it). Will first list 
	 * appropriate chars before allowing user to input them.
	 * 
