...
public class TheaterEventPane extends GridPane implements EventHandler<ActionEvent>
{
	 ...
	 * Specifically, the submit button which is used to create a TheaterEvent.
	 */
	public void handle(ActionEvent event) 
	{
		if(event.getSource() == submitB)
		{
			...
			costTF.setText("");
			musicalCB.getSelectionModel().clearSelection();
			lengthTF.setText("");
			}
			catch(Exception e)
			{
				Alert alert = new Alert(Alert.AlertType.ERROR);
				alert.setTitle("Error creating TheaterEvent object");
