...
public class SportsEventPane extends GridPane implements EventHandler<ActionEvent>
{
	...
	/**
	 * Manages how events are handled.
	 * Specifically, the submit button which is used to create a SportsEvent.
	 */
	public void handle(ActionEvent event) 
	{
		if(event.getSource() == submitB)
		{
			try
			{
				...
				Event sEvent = new SportsEvent(name, cost, location, spectators, sport);
				centerTA.appendText(sEvent.toString());
